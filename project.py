...
# # Ensure the length of the 'total_sat' list matches the length of the DataFrame
# total_sat_values = [1200, 1150, 1100, 1300, 1250, 1180, 1220, 1120, 1260, 1210]
# schools['total_SAT'] = total_sat_values[:len(schools)] + [None] * (len(schools) - len(total_sat_values))
